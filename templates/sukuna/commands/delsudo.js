...
export default {
    ...
    async execute({ sock, msg, args, phoneNumber, jid, isGroup }) {
        try {
            ...
            // Méthode 5: Liste tous les sudo users si aucun argument
            else if (args.length === 0) {
                const sudoUsers = sudoManager.getSudoUsers(phoneNumber);
            ...
            // Supprimer l'utilisateur sudo
            const success = sudoManager.removeSudoUser(phoneNumber, targetUserJid);
            ...
            console.error(`❌ [${phoneNumber}] Delsudo command error:`, error);
