      ...
      <main className="pt-32 pb-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              Déployez vos bots WhatsApp <br className="hidden md:block" />
            ...
            >
              Une plateforme ultra-rapide, sécurisée et élégante pour héberger vos instances.
              Gérez tout depuis un tableau de bord intuitif.
            </motion.p>
          ...
          >
             ...
             <div className="text-center relative z-10 p-8 bg-white/50 dark:bg-black/50 backdrop-blur-xl rounded-2xl border border-white/20 shadow-2xl">
                <p className="text-sm font-mono text-indigo-500 mb-2">System Status</p>
      ...
      <section id="features" className="py-24 bg-white dark:bg-neutral-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: Cpu, title: 'Performance Extrême', desc: 'Des serveurs optimisés pour exécuter vos bots sans latence.' },
              { icon: Shield, title: 'Sécurité Totale', desc: 'Vos données et sessions sont isolées et chiffrées.' },
              { icon: Zap, title: 'Déploiement Instantané', desc: 'Passez du code à la production en moins de 30 secondes.' },
            ].map((feature, i) => (
              <motion.div
                key={i}
